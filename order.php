            ...
            <div class="card  m-5">
                <div class="row m-5 justify-content-center align-items-center">
                    <div class="col m-0 p-0">
                        ...
                        <hr />
                        <form method="post" action="db_insertorder.php" id="orderform">
                            <div class="row justify-content-center align-items-center ">
                                <input type="hidden" name="totAmount" value="<?php echo ($tot); ?>">
                                <div class="col-8 ">
                                    ...
                                    <div id="cardDetail" class="d-none">
                                        ...
                                        <input type="password" id="cvv" name="cvv" class="form-control w-100"
                                        ...
                                        <input type="date" id="cexpiry" name="cexpiry" placeholder="Card Expiry"
                                            class="form-control w-100 mb-2" min="<%= java.time.LocalDate.now() %>"
                                            max="">
