...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light ">
        <div class="container-fluid">
            <a href="index.php" class="navbar-brand fs-2">
                <h1> Bookify</h1>
            </a>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu p-0" aria-labelledby="navbarDropdown">
                            ...
                            $typequery = "SELECT *FROM category";
                            $typeresult = mysqli_query($con, $typequery);
                            while ($typerow = mysqli_fetch_row($typeresult)) { ?>

                                <a class="dropdown-item" href="./product.php?id=<?php echo ($typerow[0]); ?>">
                                    <?php echo ($typerow[1]); ?>
                                </a>
                            <?php } ?>
                        </div>
                   ...
                   session_start();
                    if (isset($_SESSION['uid'])) { ?>
                        <li class="nav-item">
                            <a class="nav-link " href="./mywishlist.php"><i class="fa-regular fa-heart fa-xl"></i></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="./cart.php"><i class="fa-solid fa-cart-shopping  fa-xl"></i></a>

                        </li>

                        <li class="nav-item dropdown fluid">
                            <a class="nav-link btn dropdown allbtn" type="button" id="navbarDropdown">
                                <?php echo ($_SESSION['name']); ?> <br />
                            </a>
                            <div class="dropdown-menu dropdown-menu-start" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="./userprofile.php">Profile</a>
                                <a class="dropdown-item" href="./orderprofile.php">Order</a>
    ...
    <nav class="navbar  navbar-dark bg-dark">
        ...
        <div class="container-fluid">
            <form class="d-flex form-inline m-auto my-2 w-75" action="search.php">
                <input class="form-control me-2 w-75" type="search" name="search" placeholder="Search"
                    aria-label="Search">
                    <input type="hidden" id="<?php echo ($typerow[0]); ?>" name="id" />
    ...
    <div class="modal fade" id="loginModal" aria-hidden="true">
        <div class="modal-dialog">
            <form class="modal-content" id="log_form" method="post" action="checklogin.php">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-none alert alert-warning alert-dismissible fade show" role="alert" id="LoginError">
                        Invalid <strong>Email Address Or Password</strong>
    ...
    <div class="modal fade" id="register" aria-hidden="true">
        <div class="modal-dialog">
            <form class="modal-content" id="regform" method="post" action="insertregister.php">
