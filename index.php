...
<body>
    ...
    <div class="container">
      <div class="row g-3 productpart text-center">
        <div class="d-grid col-lg-4">
          <a href="product.php?value=lateset">
  ...
  <section class="mb-5">
    <div class="container booking  py-3">
      ...
      <?php
          $Query = "SELECT * FROM feedback WHERE feed_status='True'";
